				...
				<div class="panel-body">
					...
					<!-- FORM Elements -->
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="text" path="email" placeholder="JonSnow@gmail.com" class="form-control" />		
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="text" path="contactNumber" placeholder="00374XXXXXXXX" class="form-control" maxlength="13" />
			  		...
			  		<div class="form-group">
							...
							<div class="col-md-8">
								...
								<sf:errors path="confirmPassword" cssClass="help-block errHighlight" element="em" />
